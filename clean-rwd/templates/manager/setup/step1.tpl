...
<table width="100%" class="data">
	<tr ><td colspan="2">{translate key="manager.setup.emailHeaderDescription"}&nbsp;</td></tr>
	<tr >
	...
	<tr ><td colspan="2">{translate key="manager.setup.emailSignatureDescription"}&nbsp;</td></tr>
	<tr >
	...
	<tr ><td colspan="2">{translate key="manager.setup.emailBounceAddressDescription"}&nbsp;</td></tr>
	<tr >
