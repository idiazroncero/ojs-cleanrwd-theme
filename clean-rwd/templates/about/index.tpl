...
<section id="about-people" class="section">
...
<section id="about-policies" class="section">
...
<section id="about-submissions" class="section">
...
<section id="about-other" class="section">
